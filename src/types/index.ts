...
export type TUserLevelVal = (typeof UserLevel)[keyof typeof UserLevel]
export type THttpCodeVal = (typeof HttpCode)[keyof typeof HttpCode]
...
export type TExtraBandwidthDetailed = { period: 'last 24 hours' | 'this month' | 'all time' }
  & Record<TExtraTime, { in: TBandwidth, out: TBandwidth, total: TBandwidth }>
...
export type TAdminUser = Record<'full_name' | 'email' | 'timestamp' | 'user_level' | 'registered_user_id', string>
