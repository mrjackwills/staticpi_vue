<template>
	<AppCard v-intersect='onIntersect' :hasButton='false' :tile='true' :flat='true' :outlined='false' :pad='false'
		my='ma-0 pa-0' sm='12' xl='12' lg='12'>
		<template v-slot:body>
			...
			<v-row align='start' justify='center' class='ma-0 pa-0'>
				...
				<v-expand-transition>
					<v-col cols='11' class='ma-0 pa-0 mt-2' v-if='!sendMessage'>
						<ActionButton @click='sendMessage = true' :block='true' :disabled='maxConnected || ttl'
							:icon='mdiForum' color='primary' text='send message' small />
					</v-col>
				</v-expand-transition>
			...
			<v-expand-transition>
				<v-row align='start' justify='center' class='ma-0 pa-0 no-gutters mb-2'
