	...
	<section>
		<v-row align='center' :justify='justify' no-gutters class='pt-1'>
			<v-col cols='6' class='pa-0 ma-0'>
				...
				<v-text-field class='mb-n2' v-model='new_value' @focus='changeInFocus' @keydown.enter='updateMaxClients'
					:append-inner-icon='freeUser ? `` : mdiPencilOutline' :disabled='isDisabled'
					:error-messages='errorMessage' :prepend-inner-icon='mdiLanConnect' color='primary' density='compact'
