	...
	<DocumentationCard heading='Rate limits'>
		<template v-slot:doc-body>
			<p>
				...
				If <router-link :to='structured_link()' class='font-weight-bold text-primary'>structured
				...
				<br>
				<br>
				<span class='font-weight-bold'>{{ address_token }}</span> calculate rate limit on both the API key and
				the IP address of
				the requester.
